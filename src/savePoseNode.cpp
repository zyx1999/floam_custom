  ...
  public:
    ...
    void path_save(const nav_msgs::Odometry::ConstPtr& odomAftMapped)
    {
        ...
        R_velo_cam << 7.027555e-03, -9.999753e-01, 2.599616e-05, -2.254837e-03,
            -4.184312e-05, -9.999975e-01, 9.999728e-01, 7.027479e-03,
            -2.255075e-03;
...
int main(int argc, char** argv)
{
    ...
    std::string saved_path =
        "/home/yuxuanzhao/ros_workspace/floam_ws/src/floam/"
        "result/pose_trans.txt";

    nh.getParam("/saved_path", saved_path);
    OdomSaver saver(saved_path);

    ros::Subscriber save_path = nh.subscribe<nav_msgs::Odometry>(
        "/odom", 100, &OdomSaver::path_save, &saver);
